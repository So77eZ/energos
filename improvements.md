...
#### Мобильная адаптация — ✅ сделано

- Bottom-tab bar + мобильная шапка (лупа / бургер / bottom-sheet) — nav-overhaul спринт (`MobileNav`).
- Tap-targets ≥44px (hit-slop на иконках), iOS-meta (viewport-fit / динамический theme-color / appleWebApp), safe-area, фикс FAB-коллизии с таб-баром — ветка `feat/mobile-polish`.
- Живой responsive-аудит (Playwright, 375/360/landscape): поломок нет — `docs/mobile-audit-2026-06-11.md`.
