...
- Собственный отзыв текущего пользователя
...
Список всех оставленных отзывов с возможностью перейти к напитку или добавить новый.

### Управление (Admin)

Панель для добавления и удаления напитков.
...
| Действие         | Описание                                      |
| ---------------- | --------------------------------------------- |
| Добавить напиток | Создать карточку с метаданными и изображением |
| Удалить напиток  | Убрать напиток из каталога                    |
| Добавить отзыв   | Оставить оценку от имени администратора       |
| Удалить отзыв    | Удалить любой пользовательский отзыв          |

> Администраторы **не могут редактировать** значения уже существующих пользовательских отзывов — только удалять их.
...
| Стили          | Tailwind CSS v3, Framer Motion                |
